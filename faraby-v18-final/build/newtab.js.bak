...
/* palettes */
const PAL=[
  {a:'#5b8df8',a2:'#8b6cf8',abg:'rgba(91,141,248,.14)',abd:'rgba(91,141,248,.28)'},
  {a:'#9b72f8',a2:'#c084fc',abg:'rgba(155,114,248,.14)',abd:'rgba(155,114,248,.28)'},
  {a:'#2dd4bf',a2:'#34d399',abg:'rgba(45,212,191,.14)',abd:'rgba(45,212,191,.28)'},
  {a:'#f87171',a2:'#fca5a5',abg:'rgba(248,113,113,.14)',abd:'rgba(248,113,113,.28)'},
  {a:'#fbbf24',a2:'#fde68a',abg:'rgba(251,191,36,.14)',abd:'rgba(251,191,36,.28)'},
  {a:'#ec4899',a2:'#f9a8d4',abg:'rgba(236,72,153,.14)',abd:'rgba(236,72,153,.28)'},
];
...
/* state */
const DEF={name:'Friend',lm:false,analog:false,hr12:false,city:'Dhaka',wp:'',pal:0,customAc:null,todos:[],eng:{name:'Google',url:'https://google.com/search?q='},tab:'google'};
let S={...DEF};
...
function renderP(city){
  ...
  b.innerHTML=`
    <div class="pw-hd">
      <span class="pw-title">নামাজের সময়</span>
...
function init(){
  ...
  $('btn-set').addEventListener('click',openDr);$('fab').addEventListener('click',openDr);
