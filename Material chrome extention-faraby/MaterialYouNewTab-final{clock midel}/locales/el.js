...
const el = {
    ...
    "updateFirefoxHomepageInfo": "Για να αλλάξετε και την αρχική σας σελίδα όπως τη νέα καρτέλα, επισκεφθείτε <a href=\"README.md\" target=\"_blank\">αυτόν τον σύνδεσμο</a> και ακολουθήστε τις οδηγίες.",
