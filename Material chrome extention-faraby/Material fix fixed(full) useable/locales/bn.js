...
const bn = {
    ...
    "chromeShortcutsText": "ক্রোম শর্টকাট",
    "chromeShortcutsInfo": "ক্রোমের নিজস্ব শর্টকাটগুলো ইমপোর্ট করুন",
    ...
    "updateFirefoxHomepageInfo": "আপনার হোমপেজকে নতুন ট্যাবের মতো পরিবর্তন করতে, <a href=\"README.md\" target=\"_blank\">এই লিংকে</a> যান এবং নির্দেশিকা অনুসরণ করুন।",
    ...
    "confirmImportShortcuts": "আপনি কি নিশ্চিত যে আপনি ক্রোম থেকে শর্টকাটগুলো ইমপোর্ট করতে চান? এটি আপনার বর্তমান শর্টকাটগুলোকে মুছে ফেলবে।",
    "confirmImportBookmarksAsShortcuts": "সমস্ত বুকমার্ক শর্টকাট হিসেবে ইমপোর্ট করবেন? এটি আপনার বর্তমান শর্টকাটগুলো মুছে ফেলবে।",
