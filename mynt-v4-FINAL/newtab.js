...
const GAPPS = {
  ...
  prod:[
    ...
    {l:'Looker Studio',u:'https://lookerstudio.google.com'},
  ],
  media:[
    {l:'YouTube',     u:'https://youtube.com'},
    {l:'YT Music',    u:'https://music.youtube.com'},
    {l:'Photos',      u:'https://photos.google.com'},
    {l:'YouTube TV',  u:'https://tv.youtube.com'},
    {l:'Play Store',  u:'https://play.google.com'},
    {l:'Books',       u:'https://books.google.com'},
    {l:'Podcasts',    u:'https://podcasts.google.com'},
    {l:'Arts & Culture',u:'https://artsandculture.google.com'},
  ],
  cloud:[
    {l:'Cloud Console',u:'https://console.cloud.google.com'},
    ...
    {l:'Google Ads',  u:'https://ads.google.com'},
    ...
    {l:'Tag Manager', u:'https://tagmanager.google.com'},
  ],
  more:[
...
function makeApp(app, idx) {
  ...
  img.onerror = function() {
    ...
    this.parentNode.innerHTML = letter;
  };
  ico.appendChild(img);
