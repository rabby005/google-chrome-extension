...
function renderPrayer(city){
  ...
  body.innerHTML=`
    <div class="pw-hdr">
      <span class="pw-label">Prayer Times</span>
      <button class="pw-fmt-btn" id="pw-fmt">${ST.hr12?'12H':'24H'}</button>
    </div>
    <div class="pw-next">
      <div class="pw-next-lbl">Next Prayer</div>
      <div class="pw-next-row">
        <span class="pw-next-name" id="pw-nn">—</span>
        <span class="pw-next-cd"   id="pw-cd">00:00</span>
      </div>
    </div>
